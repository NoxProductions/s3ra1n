...
The `/cache` partition stores temporary system state that persists across reboots —
things like USB gadget configuration, udev persistent device rules, and usbmuxd
